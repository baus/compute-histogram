 ...
 */
function calculateHistogramWithEdges(arr, numBins = 0, trimTailPercentage = 0.00) {
    ...
    const edges = Array(numBins?numBins + 1:0).fill(0).map((_, i) => binSize ? i * binSize + min : 0 );
    console.log(edges);
